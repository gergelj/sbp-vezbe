...
insert into radnik values (220, 'Ana-Marija',  'Stokic',    NULL, 10000.00, 100.00, to_date('21-01-1971', 'DD-MM-YYYY'));
insert into radnik values (230,'Ena',  'Mirovic',    70,   35000.00,   NULL, to_date('10-12-1975', 'DD-MM-YYYY'));
insert into radnik values (240, 'Ana_Marija',  'Vidic',    NULL, 10000.00, 100.00, to_date('27-01-1979', 'DD-MM-YYYY'));
commit;